...
<html>
    ...
    <body>
        ...
        <div class="loginmodal-container">
            ...
            <center><img src="icons/pos_logo.png"></center>
            
            <h1>Admin Login</h1><br>
            
            <form action="login_general.php" method="post">
              <input type="text" name="user_name" placeholder="Username">
              <input type="password" name="password" placeholder="Password">
              <input type="submit" name="general_login" class="login loginmodal-submit" value="Login">
            </form>
