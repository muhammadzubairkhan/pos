...
<html lang="en">
    ...
    <head>
        ...
        <title>Categories - Point of Sales</title>
...
//                alert(getValue);
                ...
                var cat_name = $('#td_0213_'+id).html();
                   alert(cat_name);
                $('#exampleModalLong').modal('show');
                $('#exampleModalLong').find('#cat_name_edit').val(cat_name);             
                
                $('#exampleModalLong').find('#sumit_btn').click(function(){
                    
                    
                   cat_name = $('#exampleModalLong').find('#cat_name_edit').val();        
//                   alert(name);
//                   alert(price);
//                   alert(id);
//                   alert(barcode);
       $.ajax( { type : 'POST',
          data : { cat_name_edit:cat_name, cat_id:id },
          url  : 'functions.php',              // <=== CALL THE PHP FUNCTION HERE.
          success: function ( data ) {
...
//                   
                                ...
                                ?>
                                      ...
                                      <tr>
                                    <td id="<?php echo 'td_0213_'.$r['category_id'] ?>"><?php echo $r['cat_name'] ?></td>
                                    <td><div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                                ...
                                                <li>
                                                    <a href="#" onclick="showAjaxModal(<?php echo $r['category_id'] ?>);"><i class="entypo-pencil"></i> Edit</a>
                                                </li>
                                                <li class="divider"></li><!-- teacher DELETION LINK -->
                                                <li>
                                                    <a href="#" class="entypo-pencil" onclick="showConfirmModal(<?php echo $r['category_id'] ?>);"><i class="entypo-trash"></i> Delete</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
...
<div class="modal fade" id="exampleModalLong" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <label>Category Name</label>
        <input type="text" class="form-control" id="cat_name_edit" placeholder="Category Name...">   
      </div>
      <div class="modal-footer">
