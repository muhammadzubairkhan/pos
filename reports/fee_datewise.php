...
$stmt = $fee->generateReport($fee_date_from, $fee_date_to);
...
while ($row_fee = $stmt->fetch(PDO::FETCH_ASSOC))
{
    ...
    $stmt_student = $student->viewStudentByGr($GR_NO);
    ...
    $fee_details2 = array($GR_NO, $_SESSION["STUDENT_NAME"], $CLASS_NAME, $PAYMENT_DATE, $STATUS, $PAYMENT_METHOD, $TOTAL);
