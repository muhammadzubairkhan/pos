...
if(!isset($_SESSION["USER_NAME"]))
{
    ...
    $_SESSION["REPORT_NAME"] = "presents_attendance_sheet_".$_SESSION["CLASS"].".pdf";
...
$pdf->Write( 19, "2017 - Attendance Sheet (Total Presents ".$_SESSION["CLASS"].")" );
$pdf->Ln( 16 );
$pdf->SetFont( 'Arial', '', 10 );
