...
if(!isset($_SESSION["ORGANIZATION_NAME"]))
{
    ...
    $_SESSION["REPORT_NAME"] = "user_attendance_sheet_".$_SESSION["USER_NAME"]."_".$_SESSION["DATE_PRINTED"].".pdf";
...
$pdf->Write( 19, "2017 - Attendance Sheet ".$_SESSION["USER_NAME"] );
$pdf->Ln( 16 );
$pdf->SetFont( 'Arial', '', 10 );
$pdf->Write( 6, "Organization Name: " );
$pdf->Write( 6, $_SESSION["ORGANIZATION_NAME"] );
$pdf->Ln( 6 );
$pdf->Write( 6, "Student Name: " );
$pdf->Write( 6, $_SESSION["USER_NAME"] );
$pdf->Ln( 6 );
