...
if(!isset($_SESSION["ORGANIZATION_NAME"]))
{
    ...
    $_SESSION["REPORT_NAME"] = "attendance_sheet_".$_SESSION["DATE_PRINTED"]."_".$_SESSION["DEPARTMENT"].".pdf";
...
$data = array(
          ...
          array( "<username>", "<gr no>", 1030, 0700, 0, 1, 1, 422017 ),
          array( "<username>", "<gr no>", 1030, 0700, 0, 1, 1, 422017 ),
          array( "<username>", "<gr no>", 1030, 0700, 0, 1, 1, 422017 ),
          array( "<username>", "<gr no>", 1030, 0700, 1, 0, 1, 422017 ),
          array( "<username>", "<gr no>", 1030, 0700, 0, 1, 1, 422017 ),
...
class PDF extends FPDF
{
    ...
    **/
    ...
    {
        // Logo
        $this->Image('logo.png',10,1,30); 
        $this->SetFont( 'Arial', '', 17 );
        $this->Cell( 0, 15, "ORGANIZATION NAME", 0, 0, 'C' );
        $this->Ln( 16 );        
    }
...
$pdf->Write( 19, "2017 - Department Attendance Sheet (Month-Wise)" );
$pdf->Ln( 16 );
$pdf->SetFont( 'Arial', '', 10 );
$pdf->Write( 6, "Organization Name: " );
$pdf->Write( 6, "<name>" );
$pdf->Ln( 6 );
$pdf->Write( 6, "Department: " );
$pdf->Write( 6, "<department_name>" );
$pdf->Ln( 6 );
$pdf->Write( 6, "Month: " );
$pdf->Write( 6, "<month_name>" );
$pdf->Ln( 6 );
$pdf->Write( 6, "Year: " );
$pdf->Write( 6, "<yyyy>" );
$pdf->Cell( 0, 6, "Date Printed: <dd:mm>", 0, 0, 'R' );
...
$pdf->Ln( 12 );
$pdf->Write( 6, "* Something Like Disclaimer" );

/***
  Serve the PDF
***/

$pdf->Output( "department_monthly_attn_report.pdf", "I" );
