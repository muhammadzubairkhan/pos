...
$logoYPos = 108;
$logoWidth = 110;
$columnLabels = array( "NAME","SERVICE.NO", "IN", "OUT", "ABSENT", "PRESENT", "LEAVE", "DATE" );
...
class PDF extends FPDF
{
    ...
    **/
    ...
    function Header()
    {
        ...
        $this->Cell( 0, 15, $_SESSION["ORGANIZATION_LOGO"], 0, 0, 'C' );
        $this->Ln( 16 );        
    }
...
$pdf->Write( 19, "2017 - Attendance Sheet (".$_SESSION["DEPARTMENT"].")" );
$pdf->Ln( 16 );
$pdf->SetFont( 'Arial', '', 10 );
